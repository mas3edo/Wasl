                    ...
                    <div className="flex flex-col gap-8 lg:col-span-5">
                        ...
                        <Reveal from="right" delay={0.3}>
                            <div className="rounded-[2rem] border border-[#a9001f]/30 bg-gradient-to-br from-[#7a0011] to-[#3a0008] p-7 shadow-2xl md:p-8 text-right relative overflow-hidden group cursor-pointer transition-transform hover:-translate-y-1">
                                ...
                                <button className="rounded-full cursor-pointer bg-white px-7 py-3.5 text-[15px] font-bold text-[#7a0011] shadow-lg transition-all hover:scale-105 hover:bg-gray-50 active:scale-95">
                                    احجز موعدك الآن
                                </button>
                            </div>
                        </Reveal>
                        ...
                        <Reveal from="left" delay={0.2}>
                            <div className="rounded-[2.5rem] border border-white/5 bg-[#121624] p-8 shadow-2xl md:p-12">
                                ...
                                <form className="flex flex-col gap-6 text-right" dir="rtl" onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <button
                                        type="submit"
                                        className="mt-4 cursor-pointer flex w-full items-center justify-center gap-3 rounded-2xl bg-[#7a0011] py-4 text-lg font-bold text-white shadow-lg transition-all hover:bg-[#9a0016] hover:shadow-[0_8px_25px_rgba(122,0,17,0.4)] active:scale-[0.98]"
                                    >
                                        إرسال الرسالة
